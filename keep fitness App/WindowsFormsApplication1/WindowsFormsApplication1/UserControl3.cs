...
namespace WindowsFormsApplication1
{
    public partial class UserControl3 : UserControl
    {
        ...
        {
            string select = "select Type from Exercise";
            conn.Open();
        ...
        private void delete_item()
        {
            ...
            {
                conn.Open();
                string qry = "DELETE FROM Exercise WHERE Type ='" + textBox3.Text + "';";
        ...
        private void insert_item()
        {
            ...
            if (done && double.TryParse(textBox2.Text, out dou) == true && Int32.TryParse(textBox1.Text, out intt) == false && textBox1.TextLength > 0 && textBox2.TextLength > 0)
            {
                if (!find(textBox1.Text))
                {
                    ...
                    qry = "Insert Into Exercise(Type,calory,pic) values ('" + textBox1.Text + "','" + textBox2.Text + "','" + pic + "')";
                    cmd = new SqlCommand(qry, conn);
                    cmd.ExecuteNonQuery();
